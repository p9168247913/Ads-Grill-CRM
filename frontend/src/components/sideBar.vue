                    ...
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        <li class="active">
                            <a class="svg-icon">
                                ...
                                <router-link to="/dashboard"><span class="ml-4">Dashboards</span></router-link>
                            </a>
                        </li>
                        <li @click="isAreaExpendedTogeller(), colapseShowTogeller()" class="">
                            <a class="svg-icon" :class="{ 'collapsed': isCollapseShow }" data-toggle="collapse"
                            ...
                            <ul id="" class="iq-submenu collapse" :class="{ 'show': isCollapseShow }"
                                ...
                                <li class=" ">
                                    <a class="collapsed" data-toggle="collapse" aria-expanded="false">
                                        ...
                                        <router-link :to="getRoutePath('development')"> <span
                                                class="ml-0">Development</span></router-link>
                                ...
                                <li class=" ">
                                    <a href="" class="collapsed" data-toggle="collapse" aria-expanded="false">
                                        ...
                                        <router-link :to="getRoutePath('sales')"><span
                                                class="ml-0">Sales</span></router-link>
                                    </a>
                                </li>
                                <li class=" ">
                                    <a href="" class="collapsed" data-toggle="collapse" aria-expanded="false">
                                        ...
                                        <router-link :to="getRoutePath('hrms')"><span
                                                class="ml-4">HRMS</span></router-link>
                                    </a>
                                </li>
                            </ul>
                        </li>
