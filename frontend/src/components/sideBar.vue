        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li @click="isAreaExpendedTogeller(), colapseShowTogeller()" class="">
                    <a class="svg-icon" :class="{'collapsed':isCollapseShow }" data-toggle="collapse" :aria-expanded="isAreaExpended">                        
                        <svg class="svg-icon" width="25" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <ul id="" class="iq-submenu collapse" :class="{'show':isCollapseShow}" data-parent="#iq-sidebar-toggle">
                        <li class=" ">
                        ...
                        <li class=" ">
                            <a href="" class="collapsed" data-toggle="collapse" aria-expanded="false">
                                          ...
                                          <router-link :to="getRoutePath('hrms')"><span class="ml-4">HRMS</span></router-link>
                                      </a>
                        </li>
                    </ul>
                </li>
