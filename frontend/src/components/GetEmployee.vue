                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content" style="padding: 30px;">
                            <div class="modal-header">
                                <h5 class="modal-title" id="createRoleModalLabel">Edit Details</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle" style="margin-left: 15px !important;">
                                            ...
                                            <i class="fas fa-pencil-alt text-primary fa-xs pr-4" data-bs-toggle="modal"
                                                data-bs-target="#createRoleModal" style="color: dodgerblue !important; margin-left: 20px" ></i>
                                            ...
                                            <i class="fas fa-trash text-danger m-3 fa-xs "  @click="confirmDelete" data-toggle="tooltip"
